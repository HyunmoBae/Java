...
<body>
	<section id = "registFormArea">
		<h1>새상품등록</h1>
		<form action="dogRegist.dog" name="myForm" method="POST"
		encType="multipart/form-data">
		<table>
			<tr>
				<td class = "td_left"><label for = "dogKind">개 품종 : </label></td>
				<td class = "td_right"><input type = "text" id = "dogKind" name = "dogKind"/>
				</td>
			</tr>
			<tr>
				<td class = "td_left"><label for = "dogPrice">개 가격 : </label></td>
				<td class = "td_right"><input type = "number" id = "dogPrice" name = "dogPrice"/></td>
			</tr>
			<tr>
				<td class = "td_left"><label for = "dogImage">개 상품이미지 : </label></td>
				<td class = "td_right"><input type = "file" id = "dogImage" name = "dogImage"/></td>
			</tr>
			<tr>
				<td class = "td_left"><label for = "dogCountry">개 원산지: </label></td>
				<td class = "td_right"><input type = "text" id = "dogCountry" name = "dogCountry"/>
			</tr>
			<tr>
				<td class = "td_left"><label for = "dogHeight">개 신장: </label></td>
				<td class = "td_right"><input type = "number" id = "dogHeight" name = "dogHeight"/></td>
			</tr>
			<tr>
				<td class = "td_left"><label for = "dogWeight">개 체중: </label></td>

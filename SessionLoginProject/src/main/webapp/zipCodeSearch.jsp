		...
		<table>
			<%
				for(int i=0; i< addressList.size(); i++){
					String memberAddress1 = addressList.get(i).getDou() + " " + addressList.get(i).getSi() + " " + addressList.get(i).getGugun() + " " + addressList.get(i).getDong() + " " + addressList.get(i).getRo() + " " + addressList.get(i).getBunzi();
			%>
				<tr>
					<td>
